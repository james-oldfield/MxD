...
class LanguageModelSAERunnerConfig(RunnerConfig):
    ...
    use_transpose_decoder_init: bool = False
    use_glu: bool = False
    use_skip: bool = False
    n_experts: Optional[list] = 16_384
    topk: int = 32

    mlp_activation_fn: str = "relu"
    norm_dec: bool = True
    topk_aux_loss: bool = False

    # WANDB
    log_to_wandb: bool = True
    wandb_project: str = "transcoder_mod"
    ...
    def __post_init__(self):
        ...
        # self.checkpoint_path = f"{self.checkpoint_path}/{self.custom_name + '_' if self.custom_name else ''}{unique_id}"
