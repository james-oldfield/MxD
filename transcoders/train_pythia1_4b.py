...
def parse_args():
    ...
    parser.add_argument("--layer", type=int, default=15,
                        help="Transformer layer to hook (e.g., 15)")
    parser.add_argument("--d_in", type=int, default=2048,
                        help="Input dimension")
    parser.add_argument("--d_out", type=int, default=2048,
    ...
    parser.add_argument("--model_name", type=str, default="pythia-1.4b",
    ...
    parser.add_argument("--gate_norm", action="store_true", help="Normalize expert gating?")
    ...
    # Custom run name
    parser.add_argument("--custom_name", type=str, default="", help="Custom name for the training run")
    ...
    parser.add_argument("--checkpoint_path", type=str,
                        default="pythia1_4b-transcoders",
...
def main():
    ...
    cfg = LanguageModelSAERunnerConfig(
        ...
        hook_point=f"blocks.{args.layer}.ln2.hook_normalized",
        d_in=args.d_in,
    ...
    save_path = f"{cfg.checkpoint_path}/final_{sparse_autoencoder.get_name()}.pt"
